...
# ---------------- 髒話 ----------------
bad_words = ["靠北", "機掰", "fuck", "shit", "你媽", "幹你娘"]
funny_replies = [
    "你那麼兇是要跟本兔打架嗎(#ﾟДﾟ)",
    "是在兇屁喔(´-ω-)",
        ...
        async with session.get(url) as resp:
            if resp.status == 200:
                ...
                welcome_messages = [
                    ...
                    "{name}主人好，今天也請多多指教喵！",
                    "貓貓張開雙爪擁抱 {name}主人 🐾",
                    "喵嗚～今天也請 {name}主人多多照顧啦♡",
                    "{name}主人～快來讓貓貓蹭蹭你吧(ฅ´ω`ฅ)",
                    "{name}主人辛苦啦～快進來休息一下吧 ☕",
                    "{name}主人來啦！貓貓們已經在門口等很久了♡"
                ]
...
希望每位來到這裡的人，都能在舒服的氛圍中好好待著。

為了維持店內環境與大家的體驗，請遵守以下規則 ✦
...
## 2｜避免公開爭執
若有私人糾紛請私下處理，不要影響公開聊天室與語音房氣氛。

## 3｜禁止騷擾行為
包含持續糾纏、洗訊息、惡意跟房、不適當調情與讓人感到不舒服的互動。

## 4｜禁止散播不實資訊
請勿刻意帶風向、造謠或散播假消息。

## 5｜禁止廣告與引流
未經允許不得宣傳其他群組、社群、商業內容或外部連結。

## 6｜公開頻道請注意尺度
禁止過度裸露、限制級內容、黃色圖片影片與過激性暗示言論。

## 7｜請勿大量洗頻
包含大量貼圖、符號、重複訊息與惡意刷版。

## 8｜尊重語音房成員
進入私人語音房前請先詢問，也禁止炸麥、故意吵鬧與干擾他人。

## 9｜善用標註功能
禁止隨意 @ everyone、或大量標註成員造成干擾。

## 10｜管理團隊保有最終處理權
若有影響社群氛圍與秩序之行為，管理員將視情況進行處理。
...
若需檢舉違規行為，請詳細說明事情經過，並附上相關證據（截圖、錄影、錄音等）。

檢舉時請保持基本禮貌，勿催促處理進度、干涉管理員處理方式，管理團隊保有最終判定權。

非當事人之代替檢舉、以及私人糾紛案件，將不予受理。

若有成員讓你感到不舒服，請先明確表達拒絕或制止。

如遇惡意鬧群、炸房等情況，請立即聯繫管理員處理。
...
貴賓休息室為限定空間，請勿隨意進入或打擾正在休息的成員。

進入前請先確認是否開放，並尊重房主與現場成員意願
""")
